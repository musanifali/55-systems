...
import aboutImage1 from '../assets/images/about/05.webp';
import aboutImage2 from '../assets/images/about/06.webp';
import aboutImage3 from '../assets/images/about/14.webp';
...
const ListItem = [
  {
    id: 1,
    item: 'The old expression is absolutely true',
    icon: 'fas fa-check',
  },
  {
    id: 2,
    item: 'SMART is an acronym for Specific,',
    icon: 'fas fa-check',
  },
  {
    id: 3,
    item: 'Introspection is the trick.',
    icon: 'fas fa-check',
  },
  {
    id: 4,
    item: 'You are going on a cruise,',
    icon: 'fas fa-check',
  },
  {
    id: 5,
    item: 'we will attract confusion.',
    icon: 'fas fa-check',
  },
  {
    id: 6,
    item: 'From my perspective then',
    icon: 'fas fa-check',
  },
];
                  ...
                  return (
                    <>
                      <li className="d-flex text-primary" key={index}>
                        <i
                          className={`pe-2 pt-1 text-primary ${list.icon}`}
                        ></i>
